  ...
  return (
    <nav className="flex w-screen  justify-between items-center border-[ #E7E7E7] border-[0.1rem] h-[6rem] pr-8 pl-8">
        ...
        <div className="flex w-[32%] h-[70%]  p-[1rem] rounded-[2rem] items-center  justify-between">
            <div className="h-[3.4rem] gap-1 ml-[-5rem] rounded-[2rem] pl-[12px] p-4 bg-[#DC4A2D] border-[2px] border-[#FCB4A5] flex items-center ">
        ...
        <div className="shadow-custom-inset flex items-center h-[4rem] ml-[1rem] border-customGray border-0.5 p-4 rounded-[2rem] gap-[6.2rem] ">
            <div className="flex gap-1 items-center">
            <FiMessageSquare className="h-[1.4rem] text-[#B0B0B0]  w-[1.4rem]"  />
                <h1 className="text-[1rem] text-[#B0B0B0] font-poppins ">Messages</h1>
            </div>
            <div className="flex gap-1 items-center">
            <PiHandCoins  className="h-[1.4rem] text-[#B0B0B0]  w-[1.4rem]"/>
            <h1 className="text-[1rem] text-[#B0B0B0]  font-poppins"> Payments</h1>
            </div>
            <div className="flex gap-1 items-center">
            <GoPeople  className="h-[1.4rem] text-[#B0B0B0]  w-[1.4rem]"/>
            <h1 className="text-[1rem] text-[#B0B0B0] font-poppins"> Applications </h1>
            </div>
           </div>
        </div>
        <div className="flex items-center gap-2">
        <IoMdNotificationsOutline className="h-[1.56rem] w-[1.56rem]" />
                <img src={Bell}/>

...
const RightSection = () => {
  return (
    ...
    <div className="flex  justify-between  "> 
        <div className="flex w-[8.5rem] justify-center rounded-[0.4rem] gap-[0.5rem] items-center ml-[-1rem] h-[2.4rem] border-[0.1rem] text-[#DC4A2D] border-[#DC4A2D]  bg-[#FEF4F2]">
        <RiDeleteBin6Line className="text-[#DC4A2D]" />
        <button className="font-poppins" >Delete job
         </button>
        </div> 
        <div className="flex w-[8.5rem] justify-center rounded-[0.4rem] gap-[0.5rem] items-center mr-[-1rem] h-[2.4rem]  bg-[#DC4A2D]">
